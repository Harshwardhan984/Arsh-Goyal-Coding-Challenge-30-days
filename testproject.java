...
//-
 ...
 void payment(String name, int age, int members, double price) {//+
     Scanner sc = new Scanner(System.in);//+
     double discount = 0;//+
     double tax = 0;//+
     double totalPrice = 0;//+
     System.out.println("Do you want to apply any discount? Enter Y to apply or N to skip");//+
     char applyDiscount = sc.next().charAt(0);//+
     ...
     System.out.println("Do you want to apply any tax? Enter Y to apply or N to skip");//+
     char applyTax = sc.next().charAt(0);//+
     ...
     totalPrice = price * members;//+
     System.out.println("\nPayment Successful!");//+
     System.out.println("\nName: " + name + "\nAge: " + age + "\nMembers: " + members + "\nTotal amount to be paid :" + totalPrice);//+
 }//+
>>>>>>> Tabnine >>>>>>>// {"conversationId":"285231d4-8175-471b-a5e2-06a199901014","source":"instruct"}
}
